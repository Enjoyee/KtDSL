...
object FragmentLifecycle : FragmentManager.FragmentLifecycleCallbacks() {
    ...
    override fun onFragmentAttached(fm: FragmentManager, f: Fragment, context: Context) {
        if (Hammer.mConfig.mShowViewLifecycleLog.invoke()) {
            K.v("Fragment界面：%s onAttach", f.javaClass.canonicalName)
        }
    ...
    override fun onFragmentCreated(fm: FragmentManager, f: Fragment, savedInstanceState: Bundle?) {
        if (Hammer.mConfig.mShowViewLifecycleLog.invoke()) {
            K.v("Fragment界面：%s onCreate", f.javaClass.canonicalName)
        }
    ...
    override fun onFragmentViewCreated(fm: FragmentManager, f: Fragment, v: View, savedInstanceState: Bundle?) {
        if (Hammer.mConfig.mShowViewLifecycleLog.invoke()) {
            K.v("Fragment界面：%s onViewCreate", f.javaClass.canonicalName)
        }
    ...
    override fun onFragmentActivityCreated(fm: FragmentManager, f: Fragment, savedInstanceState: Bundle?) {
        if (Hammer.mConfig.mShowViewLifecycleLog.invoke()) {
            K.v("Fragment界面：%s onActivityCreated", f.javaClass.canonicalName)
        }
    ...
    override fun onFragmentStarted(fm: FragmentManager, f: Fragment) {
        if (Hammer.mConfig.mShowViewLifecycleLog.invoke()) {
            K.v("Fragment界面：%s onStart", f.javaClass.canonicalName)
        }
    ...
    override fun onFragmentResumed(fm: FragmentManager, f: Fragment) {
        if (Hammer.mConfig.mShowViewLifecycleLog.invoke()) {
            K.v("Fragment界面：%s onResume", f.javaClass.canonicalName)
        }
    ...
    override fun onFragmentPaused(fm: FragmentManager, f: Fragment) {
        if (Hammer.mConfig.mShowViewLifecycleLog.invoke()) {
            K.v("Fragment界面：%s onPause", f.javaClass.canonicalName)
        }
    ...
    override fun onFragmentStopped(fm: FragmentManager, f: Fragment) {
        if (Hammer.mConfig.mShowViewLifecycleLog.invoke()) {
            K.v("Fragment界面：%s onStop", f.javaClass.canonicalName)
        }
    ...
    override fun onFragmentSaveInstanceState(fm: FragmentManager, f: Fragment, outState: Bundle) {
        if (Hammer.mConfig.mShowViewLifecycleLog.invoke()) {
            K.v("Fragment界面：%s onSaveInstanceState", f.javaClass.canonicalName)
        }
    ...
    override fun onFragmentViewDestroyed(fm: FragmentManager, f: Fragment) {
        if (Hammer.mConfig.mShowViewLifecycleLog.invoke()) {
            K.v("Fragment界面：%s onDestroyView", f.javaClass.canonicalName)
        }
    ...
    override fun onFragmentDestroyed(fm: FragmentManager, f: Fragment) {
        if (Hammer.mConfig.mShowViewLifecycleLog.invoke()) {
            K.v("Fragment界面：%s onDestroy", f.javaClass.canonicalName)
        }
    ...
    override fun onFragmentDetached(fm: FragmentManager, f: Fragment) {
        if (Hammer.mConfig.mShowViewLifecycleLog.invoke()) {
            K.v("Fragment界面：%s onDetach", f.javaClass.canonicalName)
        }
